  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-black">
      ...
      <div className="text-lg mb-8 text-white">
        Sign in and explore a world of companions:
      </div>
      ...
      <div className="flex items-center justify-center space-x-4 w-full px-4">
        <img src="/fitness_trainer.png" alt="Left Side" className="w-1/4 object-cover rounded-lg ml-4"/>
        <SignIn />
        <img src="/educational_advisor.png" alt="Right Side" className="w-1/4 object-cover rounded-lg mr-4"/>
      </div>
    </div>
  );
}
